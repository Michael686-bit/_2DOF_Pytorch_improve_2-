...
class ArmEnv(object):
    ...
    def __init__(self):
        ...
        self.arm_info['l'] = [42.5 , 39.23]
        # self.arm_info['r'] = np.pi/6    # 2 angles information
        self.arm_info['r'] = [0.0,0.0]
        self.on_goal = 0
    ...
    def update_state_all(self):
        ...
        # state
        s = np.concatenate((a1xy_ / 200, finger / 200, dist1 , dist2, [1. if self.on_goal else 0.]))#dist1 + dist2
...
if __name__ == '__main__':
    ...
    for _ in range(2000):
        ...
        s, r, done, angle_all = env.step(0.01)
        print(f"s = {s}")
